...
?>
<div class="cart_totals br-20 <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h2 class="cart_totals-title"><?php esc_html_e( 'Заказ на сумму', 'woocommerce' ); ?></h2>
...
<!-- 
		...
		<div class="order-total">
			<div class="order-total-subtitle"><?php esc_html_e( 'Без учета доставки', 'woocommerce' ); ?></div>
			<div class="order-total-title" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
		</div>
