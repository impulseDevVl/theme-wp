...
<div class="shop_table woocommerce-checkout-review-order-table">
	...
	<div>
		...
		?>
		<?php /*	<div class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
	...
	<div class="woocommerce-checkout-shipping-total">

		<?php /* <div class="cart-subtotal">
		...
		<div class="order-total">
			<div class="order-total-title"><?php esc_html_e('Заказ на сумму', 'woocommerce'); ?></div>
			<div class="order-total-text">Итого с учетом доставки</div>
			<div class="order-total-title order-total-sum"><?php wc_cart_totals_order_total_html(); ?></div>
			<?php
